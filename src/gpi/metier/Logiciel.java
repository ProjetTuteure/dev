...
public class Logiciel {
    ...
    public Logiciel(int idLogiciel, String nomLogiciel, String versionLogiciel, LocalDate dateExpirationLogiciel, Facture facture) {
    ...
    public void setDateExpirationLogiciel(LocalDate dateExpirationLogiciel) {
        this.dateExpirationLogiciel=dateExpirationLogiciel;
    }
